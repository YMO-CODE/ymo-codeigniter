                ...
                <div class="row g-3">
                    <div class="col-md-12">
                        <div class="form-floating">
                            <input class="form-control<?= form_error('name') ? ' is-invalid' : ''; ?>" id="su_name" name="name" placeholder=" "
                    ...
                    <div class="col-md-6">
                        <div class="input-group">
                            ...
                            <div class="form-floating flex-grow-1">
                                <input class="form-control<?= form_error('mobile') ? ' is-invalid' : ''; ?>" id="su_mobile" name="mobile" placeholder=" "
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input type="email" class="form-control<?= form_error('email') ? ' is-invalid' : ''; ?>" id="su_email" name="email" placeholder=" "
                    ...
                    <div class="col-md-8">
                        <div class="form-floating">
                            <input class="form-control<?= form_error('area') ? ' is-invalid' : ''; ?>" id="su_area" name="area" placeholder=" "
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-floating">
                            <select class="form-select<?= form_error('city') ? ' is-invalid' : ''; ?>" id="su_city" name="city" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input type="password" class="form-control<?= form_error('password') ? ' is-invalid' : ''; ?>" id="su_pw" name="password" placeholder=" "
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input type="password" class="form-control<?= form_error('confirm') ? ' is-invalid' : ''; ?>" id="su_pw2" name="confirm" placeholder=" " required>
                    ...
                    <div class="col-12">
                        <div class="form-check">
                            <input type="checkbox" class="form-check-input<?= form_error('terms') ? ' is-invalid' : ''; ?>" id="terms" name="terms" value="1" required>
